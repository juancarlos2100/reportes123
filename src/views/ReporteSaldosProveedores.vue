    ...
    <div :class="{ 'dark-mode': isDarkMode }" class="container">
     ...
     <div>
      <form @submit.prevent="filtrarDatos">
        ...
        <label for="fechaInicio" style="font-size: 24px; font-weight: bold; padding-right: 10px; font-family: Arial, sans-serif;">Turno Inicial:</label>
        <input v-model="fechaInicio" class="form-select" :class="{ 'dark-mode-select': isDarkMode }" style="width: 400px; height: 40px;margin-right: 10px;font-size: 20px;font-family: Arial, sans-serif;">
        <label for="fehcaFin" style="font-size: 24px; font-weight: bold; padding-right: 10px; font-family: Arial, sans-serif;">Turno Final:</label>
        <input v-model="fechaFin" class="form-select" :class="{ 'dark-mode-select': isDarkMode }" style="width: 400px; height: 40px;margin-right: 10px;font-size: 20px;font-family: Arial, sans-serif;">
  ...
  export default {
   data() {
     return {
       ...
       idTipo: null,
       estatus: null,
       fechaInicio: '2024-06-01 00:00:00',
       fechaFin: '2024-06-31 23:59:59',
       dbm: 1, // Nuevo atributo para la estación
       estaciones: {},
       totalesPorNombre: {},
   ...
   methods: {
     ...
     async filtrarDatos() {
        ...
        const url = `http://192.168.1.235/admin/get.php/saldosproveedores2?fechaInicio=${this.fechaInicio}&fechaFin=${this.fechaFin}&dbm=${this.dbm}`;
